...
\author{Jonathan~D.~Rosenblatt,~\IEEEmembership{Member,~IEEE,}
        Yuval~Benjamini,~\IEEEmembership{Member,~IEEE,}
        Roee~Gilron,~\IEEEmembership{Member,~IEEE,}
        Roy~Mukamel,~\IEEEmembership{Member,~IEEE,}
        and~Jelle~J.~Goeman,~\IEEEmembership{Member,~IEEE,}%
...
We defined ``a fair comparison'' to be such that a maximal power test would have the same power, justifying our choice of fixing the Kullback–Leibler Divergence between distributions of sample means: $KL[\bar x_1,\bar x_0]=c^2 p$.
