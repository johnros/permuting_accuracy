...
\thanks{JDR was supported by the ISF 900/60 and 924/16 research grants.}% <-this % stops a space
\thanks{JDR is with with the Dept. of IE\&M at Ben-Gurion University of the Negev (johnros@bgu.ac.il). 
	YB is with with the Dept. Statistics at the Hebrew University of Jerusalem.
	RG is with Starr Lab at the UCSF.
	RM is with the Psychology Dept. at Tel Aviv University. 
	JJG is with the Leiden University Medical Center,}% <-this % stops a space
...
This general idea has been promoted in the statistical literature \cite{friedman2003multivariate}, and separately by in the machine-learning literature \cite{eric2008testing,ojala_permutation_2010,lopez2016revisiting}.
...
This can be shown by observing that a classification is a quantization of a continuous prediction. 
The information processing inequality thus applies \cite{cover2012elements}. 
Because testing power is monotone in the mutual information, a non-quantized test statistic will have no less power than a quantized one. [TODO: verify]
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{art/benjamini}}]
