---
title: "Large sample (with appropriately scaled signa)"
...
p <- 23
n <- fact* 4e1 # total sample size-> n/2 in each group.
n.permutations <- 3e2
n.folds <- 4
cost.1 <- 1e1
cost.2 <- 1e-1
...
effects <- 1/sqrt(fact) * seq(0, 0.5, length=3) # change in location
