...
Examples in the neuroscientific literature include \citet{golland_permutation_2003,pereira_machine_2009,schreiber2013statistical,olivetti2013kernel,varoquaux_assessing_2016}, and especially the recently popularized \emph{multivariate pattern analysis} (MVPA) framework of \citet{kriegeskorte_information-based_2006}.
...
Two-groups hypothesis tests may be divided into tests for equality of location (i.e., equality of means), and goodness of fit tests (i.e.equality of the two whole distribution).
...
In our running example it means that the size of the brain's region of interest is large compared to the number of observations.
...
Examples of goodness-of-fit tests include \cite{szekely_brownian_2009,gretton_kernel_2012-1} [TODO:add hall].
Examples of locations tests include \cite{schafer_shrinkage_2005,goeman2006testing,srivastava_multivariate_2007,lopes2011more,shen2015adaptive,xu2016adaptive,nishiyama2013testing} and \cite{zhang2016high}.

At this point, it becomes unclear which is preferable, in particular for genetics and neuroimaging?
A location test with a heritage dating back to \cite{hotelling_generalization_1931}?
A goodness-of-fit-test, with some recent advocates \citep[e.g.][]{olivetti2013kernel}?
Or an accuracy test, being extremely popular, as the $1,170$ citations\footnote{GoogleScholar. Accessed Aug 2017.} of \cite{kriegeskorte_information-based_2006} suggest. 
