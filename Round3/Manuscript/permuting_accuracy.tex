...
Many version of these tests exist for the multivariate case, but crucially for our applications, we we assume that the number of samples is similar to the dimension of each sample. 
...
In our running example it means that the size of the brain's region of interest is large compared to the number of observations.
 ...
 so that the spatial covariance cannot be fully estimated, then a high dimensional version of Hotelling's test can be called upon.
