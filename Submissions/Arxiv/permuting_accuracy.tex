...
\begin{figure}[th]
\centering
\includegraphics[width=0.7\linewidth]{"svm_vs_SD"}
\caption{\footnotesize
...
\begin{figure}[ht]
\centering
	  \includegraphics[width=0.7\linewidth]{"2016-08-30_18:08:08"}
	  \caption{
		  \textbf{Bootstrap--}
...
\begin{figure}[ht]
\centering
	  \includegraphics[width=0.7\linewidth]{"2016-08-17_08:48:18"}
	  \caption{
...
\begin{figure}[ht]
\centering
	  \includegraphics[width=0.7\linewidth]{"2016-08-08_07:33:05"}
...
\begin{figure}[h]
	...
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{"2016-07-26_20:55:48"}
		\caption{\textbf{Unbalanced.}} %TODO: caption  
		\label{fig:simulation_11}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
		\centering
		\includegraphics[width=1\linewidth]{"2016-07-27_11:42:05"}
...
\label{fig:n_folds}
	\begin{subfigure}{.5\textwidth}
	  \centering
	  \includegraphics[width=1\linewidth]{"2016-07-27_21:21:12"}
	  \caption{\textbf{2-fold} cross validation. Balanced folding.}  
	\label{fig:n_folds_1}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
	  \centering
	  \includegraphics[width=1\linewidth]{"2016-07-29_07:18:24"}
...
\label{fig:n_folds_unbalanced}
	\begin{subfigure}{.5\textwidth}
	  \centering
	  \includegraphics[width=1\linewidth]{"2016-08-05_09:37:35"}
	  \caption{\textbf{2-fold} cross validation. Unbalanced folding.} 
	\label{fig:n_folds_unbalanced_1}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
	  \centering
	  \includegraphics[width=1\linewidth]{"2016-08-06_07:57:22"}
...
%\label{fig:simulation_1}
	\begin{subfigure}{.5\textwidth}
	  \centering
	  \includegraphics[width=1\linewidth]{"2016-07-30_10:33:05"}
	  \caption{\textbf{Scale Change--} $\x_i =  \eta_i * \mu^ {\y^*_i}$ so that the effects are a scale change.}  
	\label{fig:scale_change}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
	  \centering
	  \includegraphics[width=1\linewidth]{"2016-08-04_19:32:17"}
...
\label{fig:large_sample}
	\begin{subfigure}{.5\textwidth}
	  \centering
	  \includegraphics[width=1\linewidth]{"2016-07-27_11:42:05zoom"}
	  \caption{\textbf{Low-Dimension--} False positive rates for $n=40$.} 
	\label{fig:large_sample_1}
	\end{subfigure}%
	\begin{subfigure}{.5\textwidth}
	  \centering
	  \includegraphics[width=1\linewidth]{"2016-08-04_13:59:33zoom"}
