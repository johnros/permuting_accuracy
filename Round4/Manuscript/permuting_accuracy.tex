...
\jmlrheading{?}{?}{?}{12/17}{?}{?}{Jonathan D. Rosenblatt, and Yuval Benjamini, and Roee Gilron, and Roy Mukamel, and Jelle J. Goeman}

\ShortHeadings{Classification for Signal Detection}{Rosenblatt, Benjamini, Gilron, Mukamel, and Goeman.}
\firstpageno{1}
...
\author{\name Jonathan D. Rosenblatt \email johnros@bgu.ac.il\\ 
	\addr Department of IE\&M and \\
	Zlotowsky Center for Neuroscience, \\
	Ben Gurion University of the Negev, Israel. 
	\AND \name Yuval Benjamini \email yuval.benjamini@mail.huji.ac.il\\
	\addr Department of Statistics, \\
	Hebrew University, Israel
	\AND \name Roee Gilron \email roee.gilron@ucsf.edu\\ 
	\addr Movement Disorders and Neuromodulation Center,\\
	University of California, San Francisco. 
	\AND \name Roy Mukamel \email roee rmukamel@post.tau.ac.il\\ 
	\addr School of Psychological Science\\
	Tel Aviv University, Israel.
	\AND \name Jelle Goeman \email J.J.Goeman@lumc.nl\\ 
	\addr Department of Medical Statistics and Bioinformatics, \\
...
\begin{keywords}
	Signal-Detection, Multivariate-Testing, Supervised-Learning, High-Dimension, Permutation-Test
\end{keywords}
...
\acks{JDR was supported by the ISF 900/60 research grant. 
