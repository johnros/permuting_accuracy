...
Interactions are understood as statements on $Y|x$. 
In particular, that the gradient of $P(Y=1|x)$ is a function of multiple coordinates. 
In this sense, the shift model includes interactions.
