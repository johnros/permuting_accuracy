...
\begin{figure}[h]
	...
	\caption{[TODO: re-run and save.image to update caption]
		\textbf{Large sample}: The basic simulation setup scaled ten-fold: $n=400; p=230$.
...
\begin{figure}[ht]
	...
	\caption{[TODO: why first statistic missing?]
		\textbf{Tie breaking}: The basic simulation setup with random tie breaking.}
	\label{fig:file33}
\end{figure}
