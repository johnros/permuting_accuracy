...
\section{Design Choices for Cross Validation}
We now address several design choices when cross validating, while bearing in mind that unlike the typical supervised learning setup, we are not interested in an unbiased estimate of $\acc_{\algo}$, but rather in the detection of its departure from chance level. 
