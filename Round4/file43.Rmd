---
title: "Logistic Regression (interactions only, augented space)"
...
beta0 <- c(rep(0,p),rep(1,p.quadratic))
...
pbPost(type = "note", body = "File43", title = the.message)
