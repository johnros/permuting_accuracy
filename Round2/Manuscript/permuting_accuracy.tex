...
[TODO: how does l2 SVM differs from SVM.CV?]
...
[TODO: this does not make sense. Verify!]
...
Varying $p$ interpolates between the null distribution $(p=0.5)$ [TODO: verify] and a location shift model $(p=0)$. 
...
\centering
	  ...
	  \caption{TODO: verify!
	  	\textbf{Mixture Alternatives.} $\x_i = \chi_i \mu + \eta_i; \chi_i = \set{-1,1}$ and $\prob{\chi_i=1}=(1/2-p)^{\y_i}  (1/2+p)^{1-\y_i}$. $\mu$ is a $p$-vector with $3/\sqrt{p}$ in all coordinates.
