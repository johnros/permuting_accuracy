...
\begin{tcolorbox}
	...
	\begin{tabular}{l|c|c|c}
		...
		\hline
		\hline
		SVM.highdim.1 & SVM & V-fold & cost=10, V=4 \\ 
		SVM.highdim.2 & SVM & b$0.632$ & cost=10, B=50 \\ 
...
\centering
	  ...
	  \caption{TODO: verify!
	  	\textbf{Mixture Alternatives.} $\x_i$ is distributed as in Eq.(\ref{eq:mixture_alternative}). 
