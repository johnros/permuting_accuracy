...
For the cases in which the purpose of the analysis is not signal detection, but rather to evaluate the performance of a particular classifier, we suggest several improvements to increase power. In particular, to replace V-fold cross validation with the leave-one-out Bootstrap.\todo{wording ...}%
\end{abstract}
...
\begin{figure}[h]
	...
	\begin{subfigure}[t]{0.4\textwidth}
		...
		\caption{TODO: recompute figure. $\mu$ in PC15 of $\Sigma$.}  
