...
\cite{ojala_permutation_2010} study the power of various accuracy tests.
Their emphasis is the effect of the underlying classifier on the power. 
They perform both a simulation study, and an empirical study, by applying various classifiers to various data sets. 
...
Like ourselves, they also find that the power incrasses with the size of the test set (Figure~4, middle). 
...
We now perform the same simulation as \cite{golland_permutation_2005}, after reparametrizing $p$ so that $p=0$ corresponds to the null model, and in the same dimensionality as our previous simualtions.
