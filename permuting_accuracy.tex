...
(b) The problem of the accuracy test with unbalanced data-sets, which motivates \cite{olivetti_statistical_2014}'s independence test, can also be remedied by replacing the accuracy statistic with its z-score, as suggested in Section~\ref{sec:estimate_accuracy}.
