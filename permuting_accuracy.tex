...
\item A major driver for the power loss is the discreteness of the test statistic. 
This discretenes, thus conservativism, can be reuced by generating test samples \emph{with replacement} (Figure~\ref{fig:bootstrap}). 
