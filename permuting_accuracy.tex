...
Inspecting Figure~\ref{fig:simulation_11}, or any other figure until now, it can be seen that Hotelling's $T^2$ test has similar power to the best performing accuracy tests. 
It may thus be argued that the real advantage of the population tests is due to their adaptation to high dimension bu regulirizing (\emph{sd} and \emph{Hotelling.shrink}).
