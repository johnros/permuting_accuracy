...
By augmenting the feature space, $\chi$, any multivariate test can be cast as a location test, so that the our focus on \emph{location tests} does not restrict the type of multivaraite tests we advocate. 
