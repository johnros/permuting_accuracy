...
The prediction accuracy, denoted $\acc_{\hat{\hyp}}$, is defined as the probability of a given classifier $\hat{\hyp}$ of making a correct prediction $\acc_{\hat{\hyp}}:=\expect{\indicator{\hat{\hyp}(x)=y}}$ when given a new, randomly drawn data point, ($\features,\outcomes$).
