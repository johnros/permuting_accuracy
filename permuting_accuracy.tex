...
%TODO: Bootstrap instead of V-fold. 

\begin{figure}[ht]
\centering
	  \missingfigure[figwidth=0.8\linewidth]{TODO:figure}
%	  \includegraphics[width=0.8\linewidth]{"art/2016-07-27 11:42:05"}
...
\cite{golland_permutation_2005} study accuracy tests using simulation, real neuroimaging and genetic data, and analytically.
Their anaytic results formalize our intuition from Section~\ref{sec:introduction} on the effect concentration of the permutatin p-value:
...
%TODO: simulate using the mixture of Golland. 
