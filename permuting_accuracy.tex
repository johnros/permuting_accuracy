...
sd & SD & -- & -- & -- \\ 
lda.CV.1 	& LDA & $\accEstim_{\algo}^{Vfold}$ 	& FALSE 	&  -- \\ 
lda.CV.2 	& LDA & $\accEstim_{\algo}^{Vfold}$ 	& TRUE 	& -- \\ 
lda.noCV.1 	& LDA & $\accEstim_{\algo}^{Resub}$ 	& FALSE 	&  --\\ 
lda.noCV.2 	& LDA & $\accEstim_{\algo}^{Resub}$ 	& TRUE 	&  --\\ 
svm.CV.1 	& SVM & $\accEstim_{\algo}^{Vfold}$ 	& FALSE 	& cost=1e1 \\ 
svm.CV.2 	& SVM & $\accEstim_{\algo}^{Vfold}$ 	& FALSE 	& cost=1e-1 \\ 
svm.CV.3 	& SVM & $\accEstim_{\algo}^{Vfold}$ 	& TRUE 	& cost=1e1 \\ 
svm.CV.4 	& SVM & $\accEstim_{\algo}^{Vfold}$ 	& TRUE 	& cost=1e-1 \\ 
svm.noCV.1 	& SVM & $\accEstim_{\algo}^{Resub}$ 	& FALSE 	& cost=1e1 \\ 
svm.noCV.2 	& SVM & $\accEstim_{\algo}^{Resub}$ 	& FALSE 	& cost=1e-1 \\ 
svm.noCV.3 	& SVM & $\accEstim_{\algo}^{Resub}$ 	& TRUE 	& cost=1e1 \\ 
svm.noCV.4 	& SVM & $\accEstim_{\algo}^{Resub}$ 	& TRUE 	& cost=1e-1 \\
\end{tabular} 
...
\hline
\hline
lda.Boot.1 & LDA & $\accEstim_{\algo}^{0.632}$ 	& $10$ & FALSE &  -- \\ 
lda.Boot.2 & LDA & $\accEstim_{\algo}^{bLOO}$ 	& $10$ & FALSE &  -- \\ 
svm.Boot.1 & SVM & $\accEstim_{\algo}^{0.632}$ 	& $10$ & FALSE & cost=1e1 \\ 
svm.Boot.2 & SVM & $\accEstim_{\algo}^{bLOO}$ 	& $10$ & FALSE & cost=1e1 \\ 
svm.Boot.3 & SVM & $\accEstim_{\algo}^{0.632}$ 	& $50$ & FALSE & cost=1e1 \\ 
svm.Boot.4 & SVM & $\accEstim_{\algo}^{bLOO}$ 	& $50$ & FALSE & cost=1e1 \\ 
\end{tabular} 
\captionsetup{type=table}
\caption{
...
\hline
\hline
svm.highdim.1 & SVM & $\accEstim_{\algo}^{Vfold}$ & FALSE & cost=1e-1, V=4 \\ 
svm.highdim.2 & SVM & $\accEstim_{\algo}^{0.632}$ & FALSE & cost=1e-1, B=50 \\ 
lda.highdim.1 & LDA & $\accEstim_{\algo}^{Vfold}$ & FALSE & -- \\ 
lda.highdim.2 & LDA & $\accEstim_{\algo}^{Vfold}$ & FALSE & -- \\ 
lda.highdim.3 & LDA & $\accEstim_{\algo}^{Vfold}$ & FALSE & -- \\ 
\end{tabular} 
\captionsetup{type=table}
\caption{
