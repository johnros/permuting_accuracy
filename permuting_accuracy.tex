...
No amount of simulations can replace one single closed form analytic result. 
The finite sample power of permutation tests is a formidable problem mathematical problem, so we currently content ourselves with simualtions. 
