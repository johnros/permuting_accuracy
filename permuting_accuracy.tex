...
(b) The tuning parameters of some test statistic are varied (cost=$10$ versus cost=$0.1$). \newline
(d) The number of folds is varied (figures \ref{fig:n_folds} and \ref{fig:n_folds_unbalanced}). \newline
