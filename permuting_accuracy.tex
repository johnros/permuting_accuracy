...
\cite{golland_permutation_2005} simulate the power of accuracy tests by sampling from a Gaussian mixture family of models, an not from a location family as our own simulations. 
Their parameter $p$ governing the separation between classes. 
Under their model 
