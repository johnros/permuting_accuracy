...
(a) The conservativeness due to discretization decreases with sample size. 
(b) Permuting features is easier than permuting labels. It allows to preserve balanced folds after a permutation without refolding. 
(c) z-scoring?
(d) balance?
(e) n.folds
(f) tunning parameter.
