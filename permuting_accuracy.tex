...
\item The presence of (positive) correlations is known to increase the data's variability, i.e., reduce the signal to noise ratio (SNR). This leads to a power reduction. 
For this reason, in the presence of correlations the importance of regularization is amplified, increasing the power difference between regularized and non-regularized test statistics (Figure~\ref{fig:ar_1}).
Put differently- in low SNR regimes, regularization is crucial.
