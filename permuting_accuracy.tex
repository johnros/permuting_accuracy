...
The noise is distributed as $\eta_i \sim \gaussp{p}{0,I}$. 
The sample size $n=40$. 
The dimension of the data is $p=23$. 
Effects, i.e. shifts $\mu$, are equal coordinate $p$-vectors with coordinates that vary over $\mu \in \set{0,1/4,1/2}$, unless stated otherwise.
