...
%TODO: fix all simulations to use minority probability!.
%TODO: check sensitivity to balance of classes.
...
Their simualtion study shows that the balance of the original data has a strong impact on the bias of the permutation test.  %TODO: effect of balane in data?
Their theoretical results formalize our intuition on the effect of the concentration of the permutatin p-value: 
The finite Vapnik–Chervonenkis (VC) dimension requirement \cite[Sec 4.3]{golland_permutation_2005} prevents the permutation p-value from concentrating. 
%TODO: how to permute?
%TODO: what is the chance level?
%TODO: why do they repornt anti-conservative findings. 
...
This is immaterial since group tests can also be performed in higher dimensions (e.g. \cite{gretton_kernel_2012-1}, or \cite{heller_consistent_2012}).
