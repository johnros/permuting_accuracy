...
This was to be expecetd, since we already saw in (e.g. Figure~\ref{fig:simulation_11}) that the \emph{unregulirized} parameter test is slightly more powerful than the \emph{unregulirized} accuracy test. 
