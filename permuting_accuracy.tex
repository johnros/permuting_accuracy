...
Their results are inline with ours in that:
(a) Their requirement that the classifier class be of finite Vapnik–Chervonenkis dimension is a formalization the intuittion that the problem cannot be too ``high-dimensional'' or the permutation test will have no power. 
(b) %TODO: how to permute?
(c) %TODO: what is the chance level?
(d) %TODO: why do they repornt anti-conservative findings. 
