...
To verify the observation that location tests have more power than accuracy tests, we compute our battery of test statistics using the MVPA analysis pipeline of \cite{stelzer_statistical_2013}, also used in \cite{gilron_quantifying_2016}. 
