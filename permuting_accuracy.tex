...
\item The insensitivity of the power to the number of folds suggests that most of the power is lost due to the discretization and not to the holdoutsize. 
...
\begin{figure}[ht]
\centering
	  \includegraphics[width=0.5\linewidth]{"art/2016-08-09 20:09:20"}
	  \caption{
		  \textbf{Bootstrap:}
		  The power of a permutation test with various test statistics. 
		  The power on the $x$ axis. 
...
\emph{lda.highdim.1} is the High-Dimensional Regularized Discriminant Analysis of \cite{ramey_high-dimensional_2016}.
\emph{lda.highdim.2} is the Diagonal Linear Discriminant Analysis of \cite{dudoit_comparison_2002}.
...
\begin{figure}[ht]
\centering
	  \includegraphics[width=0.5\linewidth]{"art/2016-08-12 07:38:43"}
...
\begin{figure}[ht]
\centering
	  \includegraphics[width=0.5\linewidth]{"art/2016-08-08 07:33:05"}
