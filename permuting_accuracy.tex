...
This is the \emph{resubstitution classification}, and simply means that the accuracy is not cross validated. 
If the data is high dimensional, the resubstitution accuracy will be very high due to over fitting \cite[Thorem 1]{mclachlan_bias_1976}. %HERE
In an extreme case, the resubstitution accuracy will be $1$ for the observed data, but also for any permutation.
The concentration of the resubstitution accuracy near $1$, and its discreteness, render this test completely useless, with a power of $0$. 
