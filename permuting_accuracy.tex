...
It may be possible to recover some of the power lost due to discretization.
There are many ways of cross-validating. 
A full review can be found in \cite{arlot_survey_2010}.
The level of discretiztion of the accuracy statisitc can be smoothed by cross validating with replacement. 
One such method, is the \emph{bootstrap}. 
