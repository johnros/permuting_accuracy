...
By augmenting the feature space, $\chi$, any multivariate test can be cast as a location test, so that the nomenclature we chose does not restrict the type of multivaraite test. 
