...
Each simulation is based on $4,000$ replications, unless stated otherwise. 
In each replication, we generate $n$ i.i.d. samples from a shift model $\y_i = \mu_i + \eta_i$.
...
We then reject the $\mu_j=0$ null hypothesis if the permutation p-value is smaller than $0.05$.
