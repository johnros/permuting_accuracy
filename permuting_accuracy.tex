...
In the spirit of the diagonilized covariance of \emph{sd}, we try a diagonlized LDA \cite{dudoit_comparison_2002}, which can be thought of a method intersecting Fisher's LDA and Naive Bayes. 
