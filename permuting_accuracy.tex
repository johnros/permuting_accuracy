...
Data generated with $\y_i = \mu_i + \eta_i; i=1,\dots,n; \eta \sim \gaussp{p}{0,I}; n=40; p=23$. 
They are assumed to be equal in all the $23$ dimensions, and vary over $0$ (red circle), $0.25$ (green triangle), and $0.5$ (blue square). 
Simulation code available at [TODO].}	
\label{fig:simulation_1}
\begin{subfigure}{.5\textwidth}
\centering
\includegraphics[width=1\linewidth]{"art/2016-07-26 20:55:48"}
\caption{\textbf{Unbalanced}.}  %TODO
...
The follwing details are common to all the reported simulations. 
Data generated as a $n$ i.i.d. samples from a shift model $\y_i = \mu_i + \eta_i$.
The noise is distributed as $\eta_i \sim \gaussp{p}{0,I}$ unless stated otherwise. 
The sample size $n=40$ unless stated otherwise. 
The dimension of the data is $p=23$. 
Effects, i.e. the shifts $\mu_i$, are equal coordinate $p$-vectors with coordinates that vary over $\mu_i \in \set{0,1/4,1/2}$, unless stated otherwise.
They are assumed to be equal in all the $23$ dimensions, and vary over $0$ (red circle), $0.25$ (green triangle), and $0.5$ (blue square). 
Simulation code available at [TODO]
...
\label{fig:n_folds_unbalanced}
	\begin{subfigure}{.5\textwidth}
	  ...
	  \caption{2 Folds. Unbalanced}  %TODO
