...
Their simualtion study shows that inbalance of the original data set may severely inflate the false alarm rates (Sec 3). 
...
\cite{golland_permutation_2005} also study the effect of the balance of the original data set, and find that if the original data set is highly unbalanced (governed by their $p$ parameter), then the permutation tests can severly inflate the false positive rates. 
%TODO: how to permute?
%TODO: verify sensitivity to balance. 
